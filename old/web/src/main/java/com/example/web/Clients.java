...
class Clients {
	...
	@Bean
	ApplicationRunner clientRunner(RestTemplate restTemplate, RestClient restClient, SlideshowClient slideshowClient) {
		return _ -> {
	...
	@Bean
	RestClient restClient(JdkClientHttpRequestFactory jdkClientHttpRequestFactory, RestClient.Builder builder) {
		return builder.requestFactory(jdkClientHttpRequestFactory).build();
	}

	@Bean
	RestTemplate restTemplate(JdkClientHttpRequestFactory jdkClientHttpRequestFactory, RestTemplateBuilder builder) {
		return builder.requestFactory(() -> jdkClientHttpRequestFactory).build();
	}
